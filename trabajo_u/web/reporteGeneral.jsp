...
<script src="framework/js/highcharts.js"></script>
<script src="framework/js/modules/exporting.js"></script>

<link rel="stylesheet" type="text/css" href="framework/gaujes/css/jquery.jqGauges.css" />
<script src="framework/gaujes/js/jquery-1.11.1.min.js" type="text/javascript"></script>
<script src="framework/gaujes/js/jquery.jqGauges.min.js" type="text/javascript"></script>
<!--[if IE]><script lang="javascript" type="text/javascript" src="framework/gaujes/js/excanvas.js"></script><![endif]-->

<script lang="javascript" type="text/javascript">
    $(document).ready(function () {

        $('#graficaLineal').jqSegmentedDisplay({
            background: 'white',
            border: {
                padding: 10,
                lineWidth: 4,
        ...
        $('#btnExport').click(function () {
            $('#graficaLineal').jqSegmentedDisplay('exportToPdf');
        });
    });
</script>
...
<script type="text/javascript">
    function recargaGraficoGeneral() {
        var chart;
    ...
    <div id="graficaLineal" style="width: 100%; height: 500px; margin: 0 auto" onclick="recargaGraficoGeneral()">
    </div>

<div>
    <input id="btnExport" type="button" value="Export to Pdf" />
</div>
