            ...
            <ul class="nav navbar-nav pull-right">
                <li class="dropdown pull-right">
                    <a data-toggle="dropdown" class="dropdown-toggle" style="cursor:pointer;">
                        <i class="fa fa-user"></i> <%=session.getAttribute("loginConexion")%><b class="caret"></b> <!-- impresión del usuario -->
                    </a>


                    <!-- Dropdown menú, es un menú desplegable, en este caso para el logout -->
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="logout"><i class="fa fa-sign-out"></i> Logout</a></li> <!-- logout, quitar sesión al sistema -->
                    </ul>
                </li>
...
<div class="content" style="margin-top:15px;">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
            ...
            <li class="open"><a style="cursor:pointer;"  class="action" name="inicio" id="Inicio"><i class="fa fa-home"></i><span class="tituloMenu"> Inicio</span></a></li> <!-- Al poner class='open' cuando se cargue esa página, quedará ese menú abierto -->
            <li class="has_sub">
    ...
    <div class="mainbar">
        ...
        <div class="page-head">
            ...
            <div class="bread-crumb pull-right">
                <a style="cursor:pointer;" class="action" name="inicio"><i class="fa fa-home"></i> Inicio</a>
            </div>
