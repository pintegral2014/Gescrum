<%-- 
    Document   : modificarProyecto2
    Created on : 17-11-2014, 16:38:32
    Author     : Dvaldebenito
--%>
...
<table class="table table-condensed table-bordered largotabla">
            ...
            <tr><th class="titulotabla largotitulos">Nombre Proyecto:</th>
            <td class="largocampos"><input class="borde  largocampos" type="text" placeholder=""  value="" required></td></tr>
            <tr><th class="titulotabla largotitulos">Descrimpcion:</th>
            ...
            <td  class="largocampos">
                <select class="form-control" data-smart-select>
                        ...
                        <option value="B">Finalizado</option>
                        <option value="C">Rechazado</option>
                    </select>
            </td></tr>
