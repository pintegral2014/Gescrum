...
INSERT INTO `gescrum`.`tbl_usuario`(`usu_nombre`,`usu_apellido_paterno`,`usu_apellido_materno`,`usu_correo`,`usu_clave`,`usu_estado`,`usu_login_conexion`,`usu_fecha_inicio`,`usu_fecha_modificacion`)VALUES('Daniel','Valdebenito','González','tanganiel@hotmail.com','123456','vigente','tanganiel',now(),now());
INSERT INTO `gescrum`.`tbl_usuario`(`usu_nombre`,`usu_apellido_paterno`,`usu_apellido_materno`,`usu_correo`,`usu_clave`,`usu_estado`,`usu_login_conexion`,`usu_fecha_inicio`,`usu_fecha_modificacion`)VALUES('Jordan','Carrasco','Donoso','jecarrasco@gmail.com','123456','vigente','jecarrasco',now(),now());
INSERT INTO `gescrum`.`tbl_usuario`(`usu_nombre`,`usu_apellido_paterno`,`usu_apellido_materno`,`usu_correo`,`usu_clave`,`usu_estado`,`usu_login_conexion`,`usu_fecha_inicio`,`usu_fecha_modificacion`)VALUES('Emilio','Landskron','Cid','kaede.keisuke@hotmail.com','123456','vigente','emilio',now(),now());
INSERT INTO `gescrum`.`tbl_usuario`(`usu_nombre`,`usu_apellido_paterno`,`usu_apellido_materno`,`usu_correo`,`usu_clave`,`usu_estado`,`usu_login_conexion`,`usu_fecha_inicio`,`usu_fecha_modificacion`)VALUES('Nicolás','Fuenzalida','Zuniga','ripcrow@hotmail.com','123456','vigente','ripcrow',now(),now());
