...
public class UsuarioDTO {
    ...
    private String usuModificadoPor;
    ...
    public UsuarioDTO(int usuId, RolDTO rol, String usuNombre, String usuApellidoPaterno,
                      ...
                      String usuLoginConexion, Date usuFechaInicio, Date usuFechaModificacion, String usuCreador, String usuModificadoPor) {
        this.usuId = usuId;
        this.rol = rol;
        ...
        this.usuModificadoPor = usuModificadoPor;
    }

    public String getUsuModificadoPor() {
        return usuModificadoPor;
    }

    public void setUsuModificadoPor(String usuModificadoPor) {
        this.usuModificadoPor = usuModificadoPor;
    }
