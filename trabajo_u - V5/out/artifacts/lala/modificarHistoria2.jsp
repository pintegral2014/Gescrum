<%-- 
    Document   : modificarHistoria2
    Created on : 17-11-2014, 16:37:36
    Author     : Dvaldebenito
--%>
...
<table class="table table-condensed table-bordered largotabla">
            ...
            <tr><th class="titulotabla largotitulos">Prioridad:</th>
            ...
            <td  class="largocampos"><select class="form-control" data-smart-select>
                    <option value="1">Ingresado</option>
                </select></td></tr>
            <tr><th class="titulotabla largotitulos">Descripción</th>
            <td  class="largocampos"><input class="borde largocampos" type="text"  value="" required></td></tr>
