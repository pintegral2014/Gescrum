...
<div class="content" style="margin-top:30px;">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="open"><a style="cursor:pointer;" class="prueba" name="inicio"><i class="fa fa-home"></i> Inicio</a></li>
          <li class="has_sub">
		<a style="cursor:pointer;"><i class="fa fa-list-alt"></i> Reportes <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
                <li><a style="cursor:pointer;" class="prueba" name="reporteGeneral" id="Reportes Generales" >Reportes Generales</a></li>
              <li><a style="cursor:pointer;" class="prueba" name="reporteSprint" id="Reporte Sprint">Reporte Sprint</a></li>
		...
		<a style="cursor:pointer;"><i class="fa fa-pencil"></i> Mantenedores <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
              <li ><a style="cursor:pointer;" class="action" name="gestionarUsuario2" id="listaUsuarios"> Gestionar Usuario</a></li>
		...
		<a style="cursor:pointer;"><i class="fa fa-terminal"></i> Ejecución <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
            <ul>
                <li><a style="cursor:pointer;" class="prueba" name="ejecutarTestCase2" id="Ejecutar TestCase"><span class=""></span>Ejecutar TestCase</a></li>
            </ul>
          </li>
          <li class="has_sub">
            ...
            <ul>
                <li><a style="cursor:pointer;" class="prueba" name="asociarHistoria2" id="Asociar Usuario"><span class=""></span>Asociar Usuario</a></li>
            </ul>
          </li>
        </ul>
    </div>
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <div class="bread-crumb pull-right">
          <a style="cursor:pointer;" class="prueba" name="inicio"><i class="fa fa-home"></i> Inicio</a> 
          <!-- Divider -->
          <span class="divider">/</span> 
          <a style="cursor:pointer;" class="bread-current prueba" name="inicio"><span id="arbol">Gescrum</span></a>
        </div>
