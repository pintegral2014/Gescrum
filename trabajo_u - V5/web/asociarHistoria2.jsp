        ...
        <div class="container">
          <div class="row">
            ...
            <tbody>
                <tr>
                    <td>Analistas A</td>
                    <td>Grupo encargados de operaciones faciles</td>
                </tr>
                <tr>
                    <td>Analistas B</td>
                    <td>Grupo encargados de operaciones Dificiles</td>
                </tr>
                <tr>
                    <td>Ingenieros A</td>
                    <td>Grupo Encargado de documentacion</td>
                </tr>
            </tbody>
        </table>
          <div class="clearfix"></div>
...
<div>
    <input type="button" class = "btn btn-default" name = "btnGrupoUsu" id="btnGrupoUsu" value="Cargar Usuarios">
</div>
<br>
